...
DOWNLOAD_URL = 'https://raw.githubusercontent.com/FFXIV-Sonar/SonarRepo/{branch}/plugins/{plugin_name}/latest.zip'
...
def add_extra_fields(manifests):
    for manifest in manifests:
        ...
        manifest['DownloadLinkInstall'] = DOWNLOAD_URL.format(branch=BRANCH, 
